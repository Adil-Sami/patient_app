...
class ReschTimeSlotPage extends StatefulWidget {
  final appId;
  final appDate;
  ...
  @override
  _ReschTimeSlotPageState createState() => _ReschTimeSlotPageState();
}

class _ReschTimeSlotPageState extends State<ReschTimeSlotPage> {
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                Column(
                                  children: [
                                    Text( widget.serviceName=="Offline"?"Walk-in Appointment".tr+" ${filledSlot}/${wspdp} "+"Slots".tr:"Video Consultant".tr+" ${filledSlot}/${vspd} "+"Slots",  style: TextStyle(
                                      fontFamily: 'OpenSans-SemiBold',
                                      fontSize: 14,
                                    )),
                                    ListView.builder(
